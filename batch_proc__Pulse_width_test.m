...
EXP_NAME = 'Pulse_width_test'
SWEEP_VALUES = [50, 100, 250, 500, 1000, 1500, 2000]
...
for exp_n = 1:100
	...
	for k = 1:length(SWEEP_VALUES)
        ...
        SIGNAL_PARAMETERS.main_pulse_width = sweep_value;
		EXP_SWEEP_NAME = sprintf('W=%1.3f', sweep_value);
