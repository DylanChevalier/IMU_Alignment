...
EXP_NAME = 'Time_drift'
SWEEP_VALUES = [0 (1/30/60) (1/15/60) (1/7/60) (1/2.5/60) 1/60 1/30]
...
for exp_n = 1:100
	...
	for k = 1:length(SWEEP_VALUES)
        ...
        SIGNAL_PARAMETERS.rs.time_drift = sweep_value;
        SIGNAL_PARAMETERS.lidar.time_drift = sweep_value;
		EXP_SWEEP_NAME = sprintf('td=%1.6f', sweep_value);
