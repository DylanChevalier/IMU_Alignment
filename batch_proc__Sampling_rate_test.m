...
EXP_NAME = 'Sampling_rate_test'
SWEEP_VALUES = [2, 3, 5, 8, 10, 15]
...
for exp_n = 1:100
	...
	for k = 1:length(SWEEP_VALUES)
        ...
        SIGNAL_PARAMETERS.rs.ts = sweep_value;
        SIGNAL_PARAMETERS.lidar.ts = sweep_value;
		EXP_SWEEP_NAME = sprintf('ts=%1.3f', sweep_value);
