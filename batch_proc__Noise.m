...
EXP_NAME = 'Noise'
SWEEP_VALUES = [0 0.01 0.025 0.05 0.1 0.25 0.5 1]
...
for exp_n = 1:100
	...
	for k = 1:length(SWEEP_VALUES)
        ...
        SIGNAL_PARAMETERS.rs.noise_sigma = sweep_value;
        SIGNAL_PARAMETERS.lidar.noise_sigma = sweep_value;
		EXP_SWEEP_NAME = sprintf('N=%1.3f', sweep_value);
